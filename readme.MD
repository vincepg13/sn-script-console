...
1. Download the latest [update set](/public/Script%20Console%20V1.0.xml) from the public folder of this repository or from [ServiceNow Share](https://developer.servicenow.com/connect.do#!/share).
